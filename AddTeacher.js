 ...
 export default class AddTeacher extends React.Component {
    ...
    render() {
      return (
       <View style={{flex: 1}}>
          <View style={{flex: 0.8}} >
          		<Text style={styles.tieude}> THÊM MỚI GIÁO VIÊN  </Text> 
          </View>
          ...
          <View style={{flex: 8}}> 
		        ...
		        <View style={[styles.flexdong , styles.khoangcach]}> 
		          <Text style={styles.txttext}> Mã Giáo Viên : </Text> 
          ...
          <View style={{flex: 1.2}}>
		          ...
		          <TouchableOpacity style={styles.btn} >
		            <Button  title="Lưu" color="#841584" onPress= {()=> this.onPressAdd()}></Button>
		          </TouchableOpacity>

		          <TouchableOpacity style={styles.btn} >
		            <Button  title="Quay lại" color="#841584" onPress ={()=> this.onPressExit()}></Button>
		          </TouchableOpacity>
		        </View>
          </View>
        </View>
